...
public class ScheduleService {
    ...
    public Schedule getSchedule(String id) {
        ...
        // Check if the schedule is present in the repository
        if (scheduleOptional.isPresent()) {
            // If present, return the schedule
            return scheduleOptional.get();
        } else {
            // If not present, you can throw an exception, return a default value, or handle it as appropriate
